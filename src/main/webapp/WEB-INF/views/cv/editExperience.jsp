    ...
    <div class="container">
        ...
        <form method="post" action='<c:url value="/editExp/${experienceModel.id}"/>'>
            <div class="form-group row">
                ...
                <div class="col-10">
                    <input type="text" class="form-control" id="exampleFormControlInput1" name="title" value="${experienceModel.title}">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-10">
                    <input type="text" class="form-control" id="exampleFormControlInput2" name="subtitle" value="${experienceModel.subtitle}">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-10">
                    <textarea type="text" class="form-control" rows="5" id="exampleFormControlInput3" name="description" value="${experienceModel.description}"></textarea>
                </div>
            </div>
            <div class="form-group row">
                <label class="col-2" for="exampleFormControlInput4">Początek</label>
                <div class="col-10">
                    <c:set var="formattedDateFrom" value="<fmt:formatDate pattern='yyyy-MM-dd' value='${experienceModel.dateFrom}'/>" />
            ...
            <div class="form-group row">
                ...
                <div class="col-10">
                    <c:set var="formattedDateTo" value="<fmt:formatDate pattern='yyyy-MM-dd' value='${experienceModel.dateTo}'/>" />
